...
def read_data():
    return ([18796, 19851, 19210, 19438, 20889, 20135, 20331, 20619, 19912], [24194, 39612, 92534, 125778, 148004, 183991, 214409, 213178, 212988])

def bar_plot():
    plots_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.realpath(__file__))), "plots")
    plot_path = os.path.join(plots_dir, "search_contending_insert_throughput.pdf")
    data = read_data()
