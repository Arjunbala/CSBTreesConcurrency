...
def read_data():
    return ([767405, 761826, 802430, 763812, 744257, 748726, 737819, 749702, 730386], [743800, 830611, 976886, 1095715, 1175568, 1178074, 1338974, 1326262, 1360661])

def bar_plot():
    plots_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.realpath(__file__))), "plots")
    plot_path = os.path.join(plots_dir, "insert_contending_search_throughput.pdf")
    data = read_data()
