...
def read_data():
    return ([24631, 24398, 26143, 25988, 28657, 27757, 24091, 23967, 24108], [26207, 40638, 96173, 129115, 149385, 208545, 217233, 218954, 217692])

def bar_plot():
    plots_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.realpath(__file__))), "plots")
    plot_path = os.path.join(plots_dir, "insert_throughput.pdf")
    data = read_data()
